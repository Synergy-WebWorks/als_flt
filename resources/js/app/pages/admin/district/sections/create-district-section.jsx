...
import { get_district_thunk, store_district_thunk } from "../redux/district-thunk";
import { get_district_service } from "@/app/services/district-service";


export default function CreateDistrictSection() {
    ...
    async function submit_form(params) {
        try {
            setLoading(true);
            const result = await store.dispatch(store_district_thunk({
                ...data,
            }));
