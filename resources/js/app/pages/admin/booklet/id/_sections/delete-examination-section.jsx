...
import { delete_examinations_thunk } from "../../../literacy_test/_redux/literacy-test-thunk";
...
export default function DeleteExaminationSection({ data }) {
    ...
    async function delete_data(params) {
        setLoading(true);
        const result = await store.dispatch(delete_examinations_thunk(data.id));
